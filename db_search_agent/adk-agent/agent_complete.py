...
root_agent = Agent(
    ...
    description="Agent to help users search and find products in the catalog. Maintains strong conversation context - remembers products discussed and answers follow-up questions about those products without asking for clarification.",
    instruction=(
